    ...
    <div class="web">
        <div class="navigation">
            <ul>
                ...
                <li>
                    <a href="calendar_implementor.php" id="active">
                        <span class="icon">
                ...
                <li>
                    ...
                    <div class="sub-menu">
                        <a href="information_implementor.php" class="sub-item">
                ...
                <li>
                    <a href="profile_implementor.php">
                        <span class="icon">
                ...
                <li>
                    <a href="homepage_implementor.php">
                        <span class="icon">
                ...
                <li>
                    <a href="about_implementor.php" class="bottom">
                        <span class="icon">
                                            ...
                                            <div class="modal fade" id="departmentModal" tabindex="-1" aria-labelledby="departmentModalLabel" aria-hidden="true" style="width: 78%; height: 655px; display: block; margin-left: 100px; margin-top: 3px; padding-right: 6px;">
                                                <div class="modal-dialog modal-lg">
                                                    ...
                                                    <div class="modal-body" style="width: 371px;">
                                                        <div class="container">
                                                            <select id="departmentFilter" onchange="toggleDropdowns()" style="width: 100%;height: 40px;text-align: center;border-radius: 10px;background: #2a2a2a;color: #f2f2f2;">
                                                                <?php
                                                                $departments = array(
                                                                    'Officials' => 'i',
                                                                    'DIT' => 'it',
